...
export default function Profile() {
  ...
  useEffect(() => {
    supabase.auth.getSession().then(async ({ data: { session } }) => {
      ...
      if (profileData) {
        ...
        console.log('Profile loaded:', { ...profileData, email: session.user.email });
  ...
  const deleteAccount = async () => {
    if (confirmDelete !== currentEmail) return;
    setDeleting(true);
      ...
      <div className="max-w-5xl mx-auto px-6 py-8">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 mb-6 flex items-center gap-5">
          ...
          <div className="flex-1">
            <p className="font-bold text-xl">{fullName || currentEmail}</p>
            ...
            {activeTab === 'security' && (
              <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6">
                ...
                <p className="text-gray-500 text-sm mb-6">
                  We will send a password reset link to <span className="text-white">{currentEmail}</span>
                </p>
            ...
            {activeTab === 'danger' && (
              <div className="bg-gray-900 border border-red-900 rounded-2xl p-6">
                ...
                <div className="space-y-3">
                  <input
                    type="text"
                    placeholder={`Type ${currentEmail} to confirm`}
                    value={confirmDelete}
                  ...
                  <button
                    ...
                    disabled={deleting || confirmDelete !== currentEmail}
